...
| **[Github Push Netlify Router](https://github.com/ramigs/netlify-lambda-github-webhook-router)** <br/> Parsing GitHub's push Webhook to decide whether or not to trigger Netlify's build and deploy for a list of sites in a mono-repository | [ramigs](http://github.com/ramigs) |
